...
export const products: Product[] = [
  ...
  },
  {
    ...
    fullContent: {
      keyDifferentiators: [
        {
          title: '1. Smart thermostat that learns human behavior',
          description: 'Smart thermostat that learns human behavior.',
          icon: 'settings',
        },
        {
          title: '2. SC-STATIC Integration',
          description: 'SC-STATIC Integration.',
          icon: 'battery',
        },
        {
          title: '3. Smart light adjustment',
          description: 'Smart light adjustment.',
          icon: 'lock',
        },
      ],
